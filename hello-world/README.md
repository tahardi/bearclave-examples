...
<!-- pluck("go", "function", "main", "hello-world/nonclave/main.go", 22, 34) -->
```go
func main() {
	// ...
		DefaultVerifyDebug,
...
<!-- pluck("go", "function", "main", "hello-world/nonclave/main.go", 35, 47) -->
```go
func main() {
	// ...
...
<!-- pluck("go", "function", "main", "hello-world/enclave/main.go", 10, 31) -->
```go
func main() {
	// ...
	config, err := setup.LoadConfig(configFile)
...
<!-- pluck("go", "function", "main", "hello-world/nonclave/main.go", 48, 63) -->
```go
func main() {
	// ...
