...
<!-- pluck("function", "main", "hello-world/nonclave/main.go", 22, 34) -->
```go
func main() {
	// ...
...
<!-- pluck("function", "main", "hello-world/nonclave/main.go", 35, 47) -->
```go
func main() {
	// ...
...
<!-- pluck("function", "main", "hello-world/proxy/main.go", 10, 30) -->
```go
func main() {
	// ...
	config, err := setup.LoadConfig(configFile)
...
<!-- pluck("function", "MakeAttestHandler", "hello-world/proxy/main.go", 0, 0) -->
```go
...
<!-- pluck("function", "main", "hello-world/enclave/main.go", 10, 31) -->
```go
func main() {
	// ...
	config, err := setup.LoadConfig(configFile)
...
<!-- pluck("function", "main", "hello-world/enclave/main.go", 36, 80) -->
```go
func main() {
	// ...
	for {
...
<!-- pluck("function", "main", "hello-world/nonclave/main.go", 48, 63) -->
```go
func main() {
	// ...
