...
func MakeHTTPGet(client *http.Client) engine.CELEngineFn {
...
func main() {
	...
	serverMux.Handle(
		"POST "+networking.AttestCELPath,
		networking.MakeAttestCELHandler(celEngine, DefaultTimeout, attester, logger),
	)
